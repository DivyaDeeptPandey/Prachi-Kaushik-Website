      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-4 lg:gap-6">
          {stats.map((stat, index) => (
            ...
            >
              ...
              {/* Label */}
              <h3 className="satoshi-medium text-md md:text-base mb-3">
                {stat.label}
              </h3>

              {/* Description */}
              <p className="satoshi-regular text-sm md:text-sm leading-tight">
                {stat.description}
              </p>
        ...
        >
          <div className="max-w-md mx-auto">
            <p className="satoshi-medium text-gray-600 text-md mb-4">
            ...
            <p className="satoshi-medium text-primary text-s">
